...
Tree.prototype = function () {
  // Subscribe to events
  _events2.default.subscribe('UpdateTree', function () {
    console.log(' EVENT - THE TREE IS UPDATED !!!!!');
  });

  _events2.default.subscribe('UpdateNode', function () {
    console.log(' EVENT - Node is UPDATED !!!!!');
  });

  _events2.default.subscribe('GetData', function () {
    console.log(' EVENT - Data about NODE !!!!!');
  });

  _events2.default.subscribe('CheckBox', function () {
  ...
  function initControlButtons() {
    ...
    updateButton.onclick = function () {
      this.update();
      _events2.default.publish('UpdateTree');
    }.bind(this
    // Update Node Data Button
      ...
      _events2.default.publish('UpdateNode');
    }.bind(this
    // append view
  ...
  return {
    ...
    updateNode: function updateNode(id, data) {
      if (!id || !data) {
        console.warn('Please provide Node Id and Data');
        return;
      }
      var item = findNodeById(this.nodes, id);
    ...
    getData: function getData(id) {
      ...
      _events2.default.publish('GetData');
    },
    subscribe: function subscribe(name, fn) {
      _events2.default.subscribe(name, fn);
    }
  };
}();
...
var Checkbox = function () {
  ...
  _createClass(Checkbox, [{
    key: 'buildView',
    value: function buildView(node, parent) {
      ...
      arrow.onclick = function (e) {
        var childnodes = (0, _jquery2.default)(e.target.parentNode).children().filter('div');
        if ((0, _jquery2.default)(arrow).hasClass('down')) {
          (0, _jquery2.default)(arrow).removeClass('down').addClass('up');
          (0, _jquery2.default)(childnodes).addClass('hide');
        } else {
          (0, _jquery2.default)(arrow).removeClass('up').addClass('down');
          (0, _jquery2.default)(childnodes).removeClass('hide');
        }
      };
      ...
      checkbox.onclick = function (e) {
        _events2.default.publish('CheckBox');
      };
...
// Create Component
var tree = window.Tree = new _tree2.default(_data2.default);
// Init Component
